...
representando o número, quantidade de horas trabalhadas 
...
public class Uri1008Uni03 {
    public static void main(String[] args) {
        ...
        int hrsTrab = input.nextInt();
        float valorHr = input.nextFloat();
        ...
        System.out.println("SALARY = U$ "+df_02.format(salario));
    }
}
